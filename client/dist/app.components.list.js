System.register(['./components/home/home.component', './components/search/queries-test.component', './components/work-tab/work-tab.component', './components/performance-tab/performance-tab.component', './components/recording-tab/recording-tab.component', './components/person-tab/person-tab.component', './components/score-tab/score-tab.component', './components/work-tab/workSubDetail.component', './components/expression/expression.list.component', './components/expression/expression.detail.component', './components/top-nav/top-nav.component', './components/search/search.component', './components/wip/wip.component'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var home_component_1, queries_test_component_1, work_tab_component_1, performance_tab_component_1, recording_tab_component_1, person_tab_component_1, score_tab_component_1, workSubDetail_component_1, expression_list_component_1, expression_detail_component_1, top_nav_component_1, search_component_1, wip_component_1;
