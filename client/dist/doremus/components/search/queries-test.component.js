System.register(['@angular/core', '@angular/router', "../../services/queries.service"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, queries_service_1;
            ...
            QueriesTestComponent = (function () {
                function QueriesTestComponent(_queriesService) {
                    ...
                    this._queriesService.getInformation('vocabulary', "<http://data.doremus.org/vocabulary/key>", 'fr')
                        .subscribe(function (queryVoc) { return _this.items = _this.queryBindVoc(queryVoc); }, function (error) { return console.error('Error: ' + error); });
                }
                QueriesTestComponent.prototype.loadQuery = function (sel) {
                    var _this = this;
                    this._queriesService.getInformation('searchQuery', "<" + sel + ">", null)
                        .subscribe(function (query) { return _this.queryResult = _this.queryBind(query); }, function (error) { return console.error('Error: ' + error); });
                };
